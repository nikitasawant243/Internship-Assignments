...
sap.ui.define([
    ...
    function journey() {
        QUnit.module("PurchaseRequisitionListListReport journey");
        ...
        opaTest("Start application", function (Given, When, Then) {
            ...
            Then.onThePurchaseRequisitionListGenerated.iSeeThisPage();
        });
        ...
        //     When.onThePurchaseRequisitionListGenerated.onFilterBar().iChangeSearchField("Search Term");
        //     When.onThePurchaseRequisitionListGenerated.onFilterBar().iExecuteSearch();
        //     Then.onThePurchaseRequisitionListGenerated.onTable(defaultTableId).iCheckRows();
        // });
        ...
        opaTest("Navigate to ObjectPage", function (Given, When, Then) {
            ...
            When.onThePurchaseRequisitionListGenerated.onFilterBar().iExecuteSearch();
            Then.onThePurchaseRequisitionListGenerated.onTable(defaultTableId).iCheckRows();
            When.onThePurchaseRequisitionListGenerated.onTable(defaultTableId).iPressRow(0);
