...
sap.ui.define([
    ...
    function journey() {
        QUnit.module("CostCentersListListReport journey");
        ...
        opaTest("Start application", function (Given, When, Then) {
            ...
            Then.onTheCostCentersListGenerated.iSeeThisPage();
        });
        ...
        //     When.onTheCostCentersListGenerated.onFilterBar().iChangeSearchField("Search Term");
        //     When.onTheCostCentersListGenerated.onFilterBar().iExecuteSearch();
        //     Then.onTheCostCentersListGenerated.onTable(defaultTableId).iCheckRows();
        // });
        ...
        opaTest("Navigate to ObjectPage", function (Given, When, Then) {
            ...
            When.onTheCostCentersListGenerated.onFilterBar().iExecuteSearch();
            Then.onTheCostCentersListGenerated.onTable(defaultTableId).iCheckRows();
            When.onTheCostCentersListGenerated.onTable(defaultTableId).iPressRow(0);
            Then.onTheCostCentersObjectPageGenerated.iSeeThisPage();
        });
